...
serverDomain.run(function () {
    ...
    serv_io.sockets.on('connection', function (socket) {
        try {
            ...
            socket.on("RFC", function () {

            });
            /***************************************************INICIO SONDA CORE***********************************************/
            
            socket.on("UpdateUserImage",function(data){
                _sondaService.UpdateUserImage(data,socket,function(error){
                    _routeSrv.SendError(error, socket);
                });
            });
            ...
            socket.on("AddMicrosurveyByClient",function(data){
                _sondaCore.insertarEncuestasPorCliente(data,socket);
            })
            ...
            socket.on('getskuseries', function () {
            ...
            socket.on("GetDefaultCurrencySymbol", function (data) {
                ...
                _routeService.GetDefaultCurrency(data, socket, function () {
            ...
            socket.on('get_task_series',
                function (data) {
                    ...
                    var connection = new pSqlInstance.Connection(pSqlConfig, function () {
                        var rowscount = 0;
            ...
            socket.on("InsertNewTasksSD", function (data) {
                console.log("InsertNewTasksSD");
                _sondaService.InsertNewTasksSD(data, socket);
            });
